...
from scratch.detect_outliers import EMBEDDING_KEYS
...
def main(argv: Sequence[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "optionally intersecting with Isolation Forest outliers."
        ),
    )
    parser.add_argument("--scores-csv", required=True, help="CSV file from scratch.detect_outliers_NFs")
